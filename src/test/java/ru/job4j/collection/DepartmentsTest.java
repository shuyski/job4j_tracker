...
public class DepartmentsTest {
    ...
    @Test
    public void sortAsc() {
        List<String> input = Arrays.asList("K1/SK1", "K1/SK1/SSK2", "K2/SK1", "K2/SK1/SSK1", "K1/SK2", "K2", "K1");
        Departments.sortAsc(input);
        List<String> expect = Arrays.asList("K1", "K1/SK1", "K1/SK1/SSK2", "K1/SK2", "K2", "K2/SK1", "K2/SK1/SSK1");
        assertThat(input, is(expect));
    }

    @Test
    public void sortDesc() {
        List<String> input = Arrays.asList("K1/SK1", "K1/SK1/SSK2", "K2/SK1", "K2/SK1/SSK1", "K1/SK2", "K2", "K1", "K2/SK1/SSK2", "K1/SK1/SSK1");
